...
export function Hero() {
  return (
    <section id="hero" className="flex min-h-screen flex-col items-center justify-center px-6 pt-14 text-center">
      <motion.h1
      ...
      <motion.p
        ...
        className="mb-3 font-mono text-sm text-white/40 tracking-widest uppercase"
      >
